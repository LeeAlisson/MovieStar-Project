<?php
    ...
    // Verifica se uário está autenticado
    ...
    if(empty($id)) {
        ...
        // Verifica se o filme foi existe
        if(!$movie){
    ...
    // Chegar se filme tem imagem
    if($movie->image == "") {
        $movie->image = "movie_cover.jpg";
    }

    // Chega se o filme é do usuário
    $userOwnsMovie = false;
            ...
            <div class="col-md-12" id="review-form-container">
                ...
                <form action="<?= $BASE_URL ?>review_process.php" id="review-form" method="POST">
                    ...
                    <div class="form-group">
                        <label for="rating">Nota do filme: <br></label>
